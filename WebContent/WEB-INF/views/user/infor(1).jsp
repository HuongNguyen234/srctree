...
<head>
	<meta charset="utf-8">
	<title>Sablanca | Thông tin người dùng</title>
	<base href="${pageContext.servletContext.contextPath}/">
    <style><%@include file="/WEB-INF/css/infor.css"%></style>
...
<body>
  ...
  <div class="title">
    ...
    <div class="infor">
        <div class="container d-flex">
            <form:form action="user/infor.htm?id=${inf.email}" modelAttribute="inf">
            <h1>Chỉnh sửa</h1>
            <div>Email:</div>
            ...
            <div class="infor-f">
		        ...
		        <div>Họ và tên: <a>${inf.account}</a></div>
